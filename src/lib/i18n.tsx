...
export const translations = {
  ...
  en: {
    ...
    about: {
      p1a: "The band's name is based on the album ",
      eccejazz: "Ecce Jazz",
      p1b: " by composer and pianist ",
      pavol: "Pavol Bodnár",
      p1c: ", which in 2006 won the ",
      aurel: "Aurel",
      p1d: " award for jazz album of the year. The band consists of renowned musicians of the Slovak jazz scene, along with a charismatic singer with a distinctive sensitive expression.",
      p2a: "Ecce Jazz Band",
      p2b: " performs original compositions by Pavol Bodnár that organically blend North and South American jazz with Slovak melodics. The repertoire includes songs from the albums ",
      album1: "ECCE JAZZ",
      p2c: " (Hevhetia 2006), ",
      album2: "Jazz and Mountains",
      p2d: " (Hudobný fond 2020), as well as new current works.",
    },
    single: {
  ...
  de: {
    ...
    about: {
      p1a: "Der Name der Band geht auf das Album ",
      eccejazz: "Ecce Jazz",
      p1b: " des Komponisten und Pianisten ",
      pavol: "Pavol Bodnár",
      p1c: " zurück, das 2006 mit dem Preis ",
      aurel: "Aurel",
      p1d: " als bestes Jazzalbum des Jahres ausgezeichnet wurde. Die Band besteht aus renommierten Musikern der slowakischen Jazzszene sowie einer charismatischen Sängerin mit einem ganz eigenen, einfühlsamen Ausdruck.",
      p2a: "Ecce Jazz Band",
      p2b: " spielt eigene Kompositionen von Pavol Bodnár, die nord- und südamerikanischen Jazz organisch mit slowakischer Melodik verbinden. Das Programm umfasst Stücke der Alben ",
      album1: "ECCE JAZZ",
      p2c: " (Hevhetia 2006), ",
