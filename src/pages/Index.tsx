    ...
    <div id="top" className="min-h-screen poster-bg text-foreground overflow-x-hidden">
      ...
      <header className="relative">
        ...
        <nav className="relative max-w-6xl mx-auto px-6 pt-8 flex items-center justify-between gap-4 flex-wrap">
          ...
          <ul className="order-3 md:order-none w-full md:w-auto flex items-center justify-between md:justify-start gap-0 md:gap-2 font-display uppercase tracking-[0.06em] md:tracking-[0.32em] text-[11px] md:text-base font-semibold rounded-full border-0 md:border md:border-primary-glow/30 bg-transparent md:bg-background-deep/60 backdrop-blur-md px-3 md:px-2 py-1.5 shadow-none md:shadow-[var(--shadow-soft)]">
            {[
